...
namespace CrmArrighi.Controllers
{
    ...
    public class ParceiroController : ControllerBase
    {
        ...
        // No-op: schema is now owned by EF migrations. Endpoint kept for API
        // surface compatibility with any existing frontend caller.
        [HttpPost("migrate-columns")]
        public ActionResult MigrateColumns()
        {
            return Ok(new { message = "Schema gerenciado por migrations EF. Nenhuma ação necessária." });
        }
