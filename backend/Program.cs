...
// Schema é gerenciado por EF Core Migrations (`dotnet ef database update`).
// Helpers SQL-Server-bruto removidos: AddDataHoraOffline, PasswordResets,
// AuditLogs CREATE TABLE inline. Quaisquer mudanças de schema devem nascer
// como nova migração.
...
using (var scope = app.Services.CreateScope())
{
    ...
    // Garantia idempotente das tabelas base de Grupos/Permissões para ambientes
    // que ainda não correram a migração `InitialCreatePg`. CREATE TABLE IF NOT EXISTS.
