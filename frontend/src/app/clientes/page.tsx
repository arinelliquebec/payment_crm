...
export default function ClientesPage() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchTerm, filterTipo, filterStatus, filterSegmento, selectedTab]);
        ...
        <div className="space-y-6">
          ...
          {error && !loading ? (
            ...
            <motion.div
              ...
              className="bg-neutral-900/95 backdrop-blur-xl rounded-2xl shadow-lg border border-neutral-800 overflow-hidden relative"
            >
              ...
              {filteredClientes.length === 0 && !loading ? (
                        ...
                        (cliente: Cliente, index: number) => (
                          ...
                          >
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              {selectedClienteId === cliente.id && (
                                <div className="mt-2 inline-flex items-center gap-2 rounded-lg border border-secondary-300 bg-secondary-100/70 px-2 py-1">
                                  <button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      handleEdit(cliente);
                                    }}
                                    className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-green-700 hover:bg-green-100 transition-colors"
                                  ...
                                  <button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      setShowDeleteConfirm(cliente.id);
                                    }}
                                    className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-red-700 hover:bg-red-100 transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                  {paginatedClientes.map((cliente: Cliente, index: number) => (
                    <motion.div
                      key={cliente.id}
                ...
                <div className="px-6 py-4 bg-neutral-800/50/30 border-t border-neutral-700/50">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                    <div className="text-xs sm:text-sm text-neutral-400 text-center sm:text-left">
                      ...
                      {Math.min(currentPage * ITEMS_PER_PAGE, filteredClientes.length)} de{" "}
